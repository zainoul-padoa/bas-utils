...
AND b.rec_id NOT IN (SELECT medisoft_id FROM bas_firms.easybill_medisoft and medisoft_id is not null) -- if it is already in easybill_medisoft, don't insert it again please!
