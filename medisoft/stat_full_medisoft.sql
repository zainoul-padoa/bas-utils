...
BEGIN
    ...
    LOOP
        ...
        ELSE
            ...
            LOOP
                EXECUTE format('SELECT COUNT(*) FROM %I.%I WHERE %I IS NOT NULL', r.table_schema, r.table_name, c.column_name)
                INTO non_null_count;
                ...
                IF distinct_count < 30 THEN
                    ...
                    INSERT INTO public.table_column_stats(table_name, column_name, total_rows, non_null, distinct_values, list_distinct_values)
                    VALUES ( r.table_name, c.column_name, total_rows, non_null_count, distinct_count, list_distinct_values);
                ELSE
                    INSERT INTO public.table_column_stats( table_name, column_name, total_rows, non_null, distinct_values)
                    VALUES ( r.table_name, c.column_name, total_rows, non_null_count, distinct_count);
